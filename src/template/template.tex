...
\usepackage[
    ...
    left=1.2 cm,     % was 2 cm; 
    right=1.2 cm,    % was 2 cm; 
...
% Larger two-column entry (main content | date/location)
\newenvironment{twocolentryL}[2][]{
    \onecolentry
    \def\secondColumn{#2}
    \setcolumnwidth{\fill, 2.7 cm}
    \begin{paracol}{2}
}{
    \switchcolumn \raggedleft \secondColumn
    \end{paracol}
...
% Side-by-side sections environment
% Usage: \begin{sidebysections}[left_width]
%        Left section content
%        \switchsection
%        Right section content
%        \end{sidebysections}
\newenvironment{sidebysections}[1][\fill]{
    \def\leftWidth{#1}
    \def\rightWidth{\fill}
    % If left width is \fill, make both columns equal
    \ifthenelse{\equal{#1}{\fill}}{
        \setcolumnwidth{0.48\textwidth, 0.48\textwidth}
    }{
        \setcolumnwidth{#1, \fill}
    }
...
% Command to switch between sections in sidebysections
\newcommand{\switchsection}{\switchcolumn}

% Side-by-side project entries (special case for projects)
% Usage: \begin{sidebyprojects}
%        \projectentry{content}{date}
%        \switchproject
%        \projectentry{content}{date}
%        \end{sidebyprojects}
\newenvironment{sidebyprojects}{
    \setcolumnwidth{0.48\textwidth, 0.48\textwidth}
    \setlength{\columnsep}{0.04\textwidth}
    \begin{paracol}{2}
}{
...
% Project entry command (for use within sidebyprojects)
...
% Switch command for projects
\newcommand{\switchproject}{\switchcolumn}
