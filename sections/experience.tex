...
\begin{twocolentry}{
    Oct 2015 - Jul 2024 % Dates
}
    \textbf{Local Summer Camps}, Volunteer Youth Leader and Educator
    \begin{highlights}
        \item Led the planning and logistics of annual summer camps
        \item Coordinated daily schedules, task assignments, and material preparation % to ensure smooth operations
        % \item Mentored and supervised junior youth leaders, supporting them in activity design and group management
        \item Mentored junior youth leaders in activity planning and group coordination
    \end{highlights}
\end{twocolentry}
